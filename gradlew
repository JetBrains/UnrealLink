...
if [ "$darwin" = "true" ]; then
    case $JVM_ARCH in
    x86_64)
        JVM_URL=https://cache-redirector.jetbrains.com/intellij-jbr/jbrsdk-17.0.3-osx-x64-b469.37.tar.gz
        JVM_TARGET_DIR=$BUILD_DIR/jbrsdk-17.0.3-osx-x64-b469.37-f87880
        ;;
    arm64)
        JVM_URL=https://cache-redirector.jetbrains.com/intellij-jbr/jbrsdk-17.0.3-osx-aarch64-b469.37.tar.gz
        JVM_TARGET_DIR=$BUILD_DIR/jbrsdk-17.0.3-osx-aarch64-b469.37-66891d
        ;;
    *) 
    ...
    JVM_URL=https://cache-redirector.jetbrains.com/intellij-jbr/jbrsdk-17.0.3-windows-x64-b469.37.tar.gz
    JVM_TARGET_DIR=$BUILD_DIR/jbrsdk-17.0.3-windows-x64-b469.37-e07e4d
else
    JVM_ARCH=$(linux$(getconf LONG_BIT) uname -m)
     case $JVM_ARCH in
        x86_64)
            JVM_URL=https://cache-redirector.jetbrains.com/intellij-jbr/jbrsdk-17.0.3-linux-x64-b469.37.tar.gz
            JVM_TARGET_DIR=$BUILD_DIR/jbrsdk-17.0.3-linux-x64-b469.37-b5d1a7
            ;;
        aarch64)
            JVM_URL=https://cache-redirector.jetbrains.com/intellij-jbr/jbrsdk-17.0.3-linux-aarch64-b469.37.tar.gz
            JVM_TARGET_DIR=$BUILD_DIR/jbrsdk-17.0.3-linux-aarch64-b469.37-91d0d3
            ;;
        *) 
            die "Unknown architecture $JVM_ARCH"
            ;;
