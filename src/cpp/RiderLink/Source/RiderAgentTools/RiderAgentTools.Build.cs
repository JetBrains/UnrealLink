...
public class RiderAgentTools : ModuleRules
{
    public RiderAgentTools(ReadOnlyTargetRules Target) : base(Target)
    {
        ...
        // RTTI is a per-toolchain compromise, because the two toolchains pull in
        // opposite directions:
        //
        //  * Clang (Apple/arm64, Linux) needs RTTI OFF. This module instantiates
        //    UE polymorphic types (TJsonValue* -> FJsonValue, FMemoryArchive/
        ...
        //    FArchive/UBlueprintFunctionLibrary" at link time (RIDER-139854, RIDER-141432).
        //
