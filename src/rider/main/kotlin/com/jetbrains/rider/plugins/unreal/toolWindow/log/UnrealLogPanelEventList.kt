...
class UnrealLogPanelEventList(project:Project) : JBList<LogPanelItem>(emptyList()), DataProvider, CopyProvider {
    val riderModel: DefaultListModel<LogPanelItem>
        get() = model as DefaultListModel<LogPanelItem>

    init {
        cellRenderer = UnrealLogPanelEventRenderer()
    ...
    fun getNavigatableForSelected(list: UnrealLogPanelEventList, project: Project): Navigatable? {
