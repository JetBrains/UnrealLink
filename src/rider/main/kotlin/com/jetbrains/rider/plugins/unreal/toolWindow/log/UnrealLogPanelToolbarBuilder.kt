...
object UnrealLogPanelToolbarBuilder {
    private fun create(actionGroup: ActionGroup, layout: String, horizontal: Boolean): JPanel {
        val component = ActionManager.getInstance()
            .createActionToolbar(UnrealToolWindowFactory.ACTION_PLACE, actionGroup, horizontal)
            .component
    ...
    fun createLeftToolbar(model: UnrealLogPanelModel, mainSplitterToggleAction: DumbAwareAction, consoleActionsList : List<AnAction> = listOf()): JPanel {
