...
import com.jetbrains.rider.test.scriptingApi.setReSharperSetting
...
////        get() = this.javaClass.simpleName
    ...
    fun suiteSetup() {
        unrealInfo = UnrealTestInfo(testingVersions)
    ...
    // temp
    fun openProject(openWith: UnrealTestInfo.UnrealOpenType): Project {
...
//        openSolutionParams.preprocessSolutionFile = { getProjectFile(it) }
//        openSolutionParams.customSolutionName = "$projectDirectoryName.uproject"
//
//        return openSolution(projectDirectoryName, openSolutionParams)
//    }

    private fun getProjectFile(openWith: UnrealTestInfo.UnrealOpenType): File {
        if (openWith == UnrealTestInfo.UnrealOpenType.Uproject)
            return uprojectFile
