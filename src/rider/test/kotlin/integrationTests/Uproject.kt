...
import com.jetbrains.rider.test.base.BaseTestWithProject
...
class ConnectionWithUproject : BaseTestWithProject() {
    ...
    override fun getCustomSolutionFileName(): String = "EmptyUProject.uproject"
